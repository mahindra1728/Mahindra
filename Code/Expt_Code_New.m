...
for destination = 8
    ...
    warning('off')
    format short g
    Main_Folder = 'E:\Mahindra\EEGDATA\';
...
%         
        ...
        for k=1:length(Folder)
            ...
            for m = 1:6
                ...
                x_1=get(h1,'Xdata');
                y_1=get(h1,'Ydata');
                upper_limit_1 = floor(y_1(1) + 5-rem(y_1(1),5));
                ylim([0 upper_limit_1])
                xlabel('Frequency')
                title('PSD(1)')
                grid on
                ylabel({'S({\omega})';'{\mu}V^2/Hz'})
                S_theta1 = mean(y_1(5:8)); S_alpha1 = mean(y_1(9:13)); S_beta1 = mean(y_1(14:31));%S_gamma1 = mean(y_1(22:26));
                
                % 1ST ALARM TO fIRST SLIDER ACTION
                subplot(2,2,2)
                pop_spectopo(EEG, 1, [start_alarm(1,1)*512  start_scenario(4,1)*512], 'EEG' , 'freqrange',[2 30],'electrodes','on'); % Task to 1st slider action
                h2 = findobj(gca,'Type','line');
                x_2=get(h2,'Xdata');
                y_2=get(h2,'Ydata');
                upper_limit_2 = y_2(1) + 5-rem(y_2(1),5);
                ylim([0 upper_limit_2]);
                ylabel({'S({\omega})';'{\mu}V^2/Hz '})
                xlabel('Frequency')
                title('PSD(2)')
                grid on
                S_theta2 = mean(y_2(5:8)); S_alpha2 = mean(y_2(9:13)); S_beta2 = mean(y_2(14:31));%S_gamma2 = mean(y_2(22:26));
                ...
                x_3=get(h3,'Xdata');
                y_3=get(h3,'Ydata');
                upper_limit_3 = y_3(1) + 5-rem(y_3(1),5);
                ylim([0 upper_limit_3]);
                ylabel({'S({\omega})';'{\mu}V^2/Hz '})
                xlabel('Frequency')
                title('PSD(3)')
                grid on
                S_theta3 = mean(y_3(5:8)); S_alpha3 = mean(y_3(9:13)); S_beta3 = mean(y_3(14:31));%S_gamma3 = mean(y_3(22:26));
                ...
                for range_of_freq = 1:3
                    ...
                    if strcmpi(table2array(alarm_name{k,m}(1,1)),'F102_low') || strcmpi(table2array(alarm_name{k,m}(1,1)),'F102_high')
                        ...
                        figure(o)
                        subplot(3,2,[1,2])
                        plot(time,process_raw{k,m}{1,1}(:,4),'b','LineWidth',2)
                        hold on
                        ...
                        hold on
                        text(mouseclick1{k,m}(1,1),0.02,'Start','Rotation',90,'FontSize',6,'Color','g') % Noting the start location in the time range
                        ...
                        for i = 1:length(Index_alarm(:,1))
                            if sum(strcmpi(alarm_name1{k,m}(i,1),'F102_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'F102','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',8)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'F102_cleared'))>=1
                                ...
                                plot(time_Tlow,y,'s','MarkerFaceColor','green','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'F102','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'F102_high'))>=1
                                ...
                                plot(time_Tlow,y,'^','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'F102','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                        ...
                        if sum(index4)>=1
                            ...
                            text(time_mouse_click(index4),0.01,'SC','Rotation',90,'FontSize',6)
                        elseif sum(index5)>=1
                            plot(time_mouse_click(index5),0,'s','MarkerFaceColor','red','MarkerSize',8)
                            text(time_mouse_click(index5),0.01,'ASD','Rotation',90,'FontSize',6)
                        else
                            plot(time_mouse_click(index6),0,'s','MarkerFaceColor','red','MarkerSize',8)
                            text(time_mouse_click(index6),0.01,'ESD','Rotation',90,'FontSize',6)
                        end
                        xlabel('Time in Seconds')
                    ...
                    elseif strcmpi(table2array(alarm_name{k,m}(1,1)), 'F101_high') || strcmpi(table2array(alarm_name{k,m}(1,1)),'F101_low')
                        ...
                        figure(o)
                        subplot(5,2,[1,2])
                        plot(time,process_raw{k,m}{1,1}(:,3),'b','LineWidth',2)
                        hold on
...
%                         xlabel('Time in Seconds')
                        ylabel('F101')
                        ylim([F101_ll-400 F101_ul+450])
                        xlim([mouseclick1{k,m}(1,1)-10 time(length(time),1)+10])
                        
                        subplot(5,2,[3,4])
                        plot(time,process_raw{k,m}{1,1}(:,7),'b','LineWidth',2)
                        ylim([F105_ll-400 F105_ul+450])
                        xlim([mouseclick1{k,m}(1,1)-10 time(length(time),1)+10])
                        hold on
...
%                         xlabel('Time in Seconds')
                        ...
                        subplot(5,2,[5,6])
                        plot(time,process_raw{k,m}{1,1}(:,12),'b','LineWidth',2)
                        ylim([C101_ll-250 C101_ul+250])
                        xlim([mouseclick1{k,m}(1,1)-10 time(length(time),1)+10])
                        hold on
...
%                         xlabel('Time in Seconds')
                        ...
                        text(time_tags_flow,y,char(alarms_flow),'Rotation',90,'FontSize',8);
                        hold on
                        text(mouseclick{k,m}(1,1),0.02,'Start','Rotation',90,'FontSize',6,'Color','g'); % Noting the start location in the time range
                        ...
                        for i = 1:length(Index_alarm(:,1))
                            if sum(strcmpi(alarm_name1{k,m}(i,1),'F101_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'F101','Rotation',90,'FontSize',6);
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6);
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'F105_low'))>=1
                                ...
                                alarm_T= split(alarm(index),"_");
                                alarm_Tlow = char(alarm_T(:,1));
                                 y = zeros(length(index),1)+0.01;
                                plot(time_Tlow,y+0.49,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,0.05,'F105','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'C101_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'C101','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'F105_cleared'))>=1
                                ...
                                plot(time_Tlow,y,'s','MarkerFaceColor','green','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'F105','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                        ...
                        figure(o)
                        subplot(5,2,[1,2])
                        plot(time,process_raw{k,m}{1,1}(:,9),'b','LineWidth',2)
                        ...
                        subplot(5,2,[3,4])
                        plot(time,process_raw{k,m}{1,1}(:,8),'b','LineWidth',2)
                        ...
                        subplot(5,2,[5,6])
                        plot(time,process_raw{k,m}{1,1}(:,10),'b','LineWidth',2)
                        ...
                        for i = 1:length(Index_alarm(:,1))
                            if sum(strcmpi(alarm_name1{k,m}(i,1),'T104_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'T104','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'T105_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'T105','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'T106_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.01,'T106','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.01,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
