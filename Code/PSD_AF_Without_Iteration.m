    ...
    load(strcat('Participant',num2str(destination),'_For_Adaptive filter_PSD.mat'));
        ...
        for k=1:length(Folder1)
            ...
            for m =1:6
                ...
                EEG = pop_importdata('dataformat','ascii','nbchan',1,'data',strcat(Parent_Folder1,participant,'.',num2str(k),'\eeg_data_Adaptive_filter_WI.txt'),'setname','applicant','srate',512,'pnts',1,'xmin',0);
...
%                 ylim([0 upper_limit_2]);
                ...
                filename = strcat(path,'PSD_After_Time_Series_Adaptive_Filter_without_Iteration','.xlsx');
