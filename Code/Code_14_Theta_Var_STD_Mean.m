%% This code is for match and mismatch processing FOR THETA CASE
    ...
    for i = 1
        ...
        for k=1:length(Folder)
            ...
            for m=1:6
                ...
                for q = 1:7
                    read={strcat(path,'Experiment_new_rest'),strcat('Sheet',num2str(q))};    %% EXPERIMENT+REST SHEET CONTAINING THETA, ALPHA AND BETA
                ...
                for wave =1:3
                    for sample = 1:2
                        if sample == 1
                            figure(plotstat)
                            type = '_task_action';
                            base = transpose(cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),'_rest{',num2str(1),',',num2str(1),'}'))));
                            task_value = cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),type,'{',num2str(1),',',num2str(1),'}(:,',num2str(m),')')));
                            ...
                            xlabel('Experiment')
                            xlim([0 length(Folder)])
                            
                            base = transpose(cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),'_rest{',num2str(1),',',num2str(1),'}'))));
                            task_value = cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),type,'{',num2str(1),',',num2str(1),'}(:,',num2str(m+1),')')));
                            vector = [base,task_value];
                            subplot(2,6,(m+1))
                            bar(vector,2);
                            ...
                            base = transpose(cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),'_rest{',num2str(1),',',num2str(1),'}'))));
                            task_value = cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),type,'{',num2str(1),',',num2str(1),'}(:,',num2str(m+2),')')));
                            vector = [base,task_value];
                            subplot(2,6,(m+2))
                            bar(vector,2);
                            ...
                            base = transpose(cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),'_rest{',num2str(1),',',num2str(1),'}'))));
                            task_value = cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),type,'{',num2str(1),',',num2str(1),'}(:,',num2str(m+3),')')));
                            vector = [base,task_value];
                            subplot(2,6,(m+3))
                            bar(vector,2);
                            ...
                            base = transpose(cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),'_rest{',num2str(1),',',num2str(1),'}'))));
                            task_value = cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),type,'{',num2str(1),',',num2str(1),'}(:,',num2str(m+4),')')));
                            vector = [base,task_value];
                            subplot(2,6,(m+4))
                            bar(vector,2);
                            ...
                            base = transpose(cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),'_rest{',num2str(1),',',num2str(1),'}'))));
                            task_value = cell2mat(eval(strcat('PSD_',waves(wave),'_',statistic(plotstat),type,'{',num2str(1),',',num2str(1),'}(:,',num2str(m+5),')')));
                            vector = [base,task_value];
                            subplot(2,6,(m+5))
                            bar(vector,2);
...
%                             title(strcat('PSD ',Properties(plotstat),' COMPARISON IN REST AND ACTION PHASE FOR ',name_participant{destination}))
                        ...
                        a = axes;
                        t1 = title({strcat(name_participant,'EXPERIMENT',num2str(k),' PSD- ',upper(waves(wave)),'-',Properties(plotstat));''});
                        a.Visible = 'off'; % set(a,'Visible','off');
                        t1.Visible = 'on'; % set(t1,'Visible','on');
                        print(figure(plotstat),fullfile(strcat(Parent_Folder),[strcat(name_participant,' EXPERIMENT- ',num2str(k),' PSD- ',upper(waves(wave)),'-',Properties(plotstat),'_TASK_ALL', '.png')]),'-dpng','-r1200');
...
for Participant = 1:10
    for m=1:6
        for i = 1:size(Conclusion_alpha{Participant,1},1)
            length_PSD = length(PSD_ALPHA{Participant,1}{i,m});
            for zone = 1:length(Conclusion_alpha{Participant,1}{i,m})
                if PSD_ALPHA{Participant,1}{i,m}(1,zone)<PSD_ALPHA{Participant,1}{i,m}(1,zone+1) &&  Conclusion_alpha{Participant,1}{i,m}(1,zone) == 1
                    Percentage_Change_match_mismatch_alpha{i,m}(zone,1) = 100*(PSD_ALPHA{Participant,1}{i,m}(1,zone+1) - PSD_ALPHA{Participant,1}{i,m}(1,zone))/PSD_ALPHA{Participant,1}{i,m}(1,zone);
                elseif PSD_ALPHA{Participant,1}{i,m}(1,zone)>PSD_ALPHA{Participant,1}{i,m}(1,zone+1) && Conclusion_alpha{Participant,1}{i,m}(1,zone) ==-1
                    Percentage_Change_match_mismatch_alpha{i,m}(zone,1) = 100*(PSD_ALPHA{Participant,1}{i,m}(1,zone+1) - PSD_ALPHA{Participant,1}{i,m}(1,zone))/PSD_ALPHA{Participant,1}{i,m}(1,zone);
                else
...
for Participant = 1:10
    for m=1:6
        for i = 1:size(Conclusion_beta{Participant,1},1)
            length_PSD = length(PSD_BETA{Participant,1}{i,m});
            for zone = 1:length(Conclusion_beta{Participant,1}{i,m})
                if PSD_BETA{Participant,1}{i,m}(1,zone)>PSD_BETA{Participant,1}{i,m}(1,zone+1) &&  Conclusion_beta{Participant,1}{i,m}(1,zone) == 1
                    Percentage_Change_match_mismatch_beta{i,m}(zone,1) = 100*(PSD_BETA{Participant,1}{i,m}(1,zone+1) - PSD_BETA{Participant,1}{i,m}(1,zone))/PSD_BETA{Participant,1}{i,m}(1,zone);
                elseif PSD_BETA{Participant,1}{i,m}(1,zone)<PSD_BETA{Participant,1}{i,m}(1,zone+1) && Conclusion_beta{Participant,1}{i,m}(1,zone) ==-1
                    Percentage_Change_match_mismatch_beta{i,m}(zone,1) = 100*(PSD_BETA{Participant,1}{i,m}(1,zone+1) - PSD_BETA{Participant,1}{i,m}(1,zone))/PSD_BETA{Participant,1}{i,m}(1,zone);
                else
...
for Participant = 1:10
    for i = 1 :size(Conclusion_alpha{Participant,1},1)
        ...
        SUM_NO_CONCLUSION_alpha{Participant,1}{i,1} = sum(cell2mat(sum_misclassification_alpha(i,:)));
    ...
    Sum_total_match_mismatch_noconclusion_alpha{Participant,1} = cell2mat(sum_total_alpha);
    Percentage_alpha_experiment{Participant,1} = cell2mat(percentage_alpha_prediction');
...
for Participant = 1:10
    for i = 1 :size(Conclusion_beta{Participant,1},1)
        ...
        SUM_MATCH{Participant,1}{i,1} = sum(cell2mat(sum_match_beta(i,:)));
        SUM_MISMATCH{Participant,1}{i,1} = sum(cell2mat(sum_mismatch_beta(i,:)));
        SUM_MISCLASSIFICATION{Participant,1}{i,1} = sum(cell2mat(sum_misclassification_beta(i,:)));
        SUM_TOTAL{Participant,1}{i,1} = sum(cell2mat(sum_total_beta(i,:)));
    end

    Sum_experiment_match_mismatch{Participant,1} = cell2mat(sum_i);
    Sum_total_match_mismatch_noconclusion{Participant,1} = cell2mat(sum_total_beta);
    Percentage_beta_experiment{Participant,1} = cell2mat(percentage_beta_prediction');
