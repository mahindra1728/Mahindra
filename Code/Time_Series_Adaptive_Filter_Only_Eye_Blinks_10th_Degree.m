...
%         end
        ...
        fnm =[Parent_Folder strcat(participant,'.',num2str(k)) '\' 'eeg_data_Adaptive_filter_WI_10degree_Only_Eye_Blinks.txt'];
        fid = fopen(fnm,'wt');
        fprintf(fid,'%.2f\n',eeg_Adaptive_filtered_data);
        fclose(fid);
        save('eeg_data_Adaptive_filter_WI_10degree_Only_Eye_Blinks.txt','data_to_be_filtered','-ascii')
    end
end