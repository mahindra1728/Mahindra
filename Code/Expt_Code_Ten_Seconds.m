...
%                 print(figure(L),fullfile(path,['PSD_expt_',num2str(k),'_Task_',num2str(m),'_part_all', '.png']),'-dpng','-r800');
                ...
                clear x y time S_theta S_alpha S_beta
                for i = 1:N-1
                ...
                data_PSD = [y_1' y_2' y_3_10seconds];
                sheet = m;
                xlRange = 'A';
...
%                         xlabel('Time in Seconds')
                        ...
                        y = zeros(length(Index_time),1)+0.05;
                        text(time_tags_flow,y,char(alarms_flow),'Rotation',90,'FontSize',6)
                        hold on
                        text(mouseclick1{k,m}(1,1),0.04,'Start','Rotation',90,'FontSize',6,'Color','b') % Noting the start location in the time range
                        ...
                        for i = 1:length(Index_alarm(:,1))
                            if sum(strcmpi(alarm_name1{k,m}(i,1),'F102_low'))>=1
                                ...
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'F102','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                        ...
                        if sum(index4)>=1
                            ...
                            text(time_mouse_click(index4),0.05,'SC','Rotation',90,'FontSize',6,'Color','b')
                        elseif sum(index5)>=1
                            plot(time_mouse_click(index5),0,'s','MarkerFaceColor','red','MarkerSize',8)
                            text(time_mouse_click(index5),0.05,'ASD','Rotation',90,'FontSize',6,'Color','r')
                        else
                            plot(time_mouse_click(index6),0,'s','MarkerFaceColor','red','MarkerSize',8)
                            text(time_mouse_click(index6),0.05,'ESD','Rotation',90,'FontSize',6,'Color','r')
                        end
                        xlabel('Time in Seconds')
...
%                         xlabel('Time in Seconds')
                        ...
                        y = zeros(length(Index_time),1)+0.05;
                        text(time_tags_reactor,y,char(alarms_flow_reactor),'Rotation',90,'FontSize',6);
                        hold on
                        ...
                        for i = 1:length(Index_alarm(:,1))
                            if sum(strcmpi(alarm_name1{k,m}(i,1),'F101_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'F101','Rotation',90,'FontSize',6);
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6);
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'C101_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'C101','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'F105_cleared'))>=1
                                ...
                                plot(time_Tlow,y,'s','MarkerFaceColor','green','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'F105','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                        ...
                        if sum(index4)>=1
                            plot(time_mouse_click(index4),0,'s','MarkerFaceColor','green','MarkerSize',8)
                            text(time_mouse_click(index4),0.05,'SC','Rotation',90,'FontSize',6)
                        elseif sum(index5)>=1
                            plot(time_mouse_click(index5),0,'s','MarkerFaceColor','red','MarkerSize',8)
                            text(time_mouse_click(index5),0.05,'ASD','Rotation',90,'FontSize',6)
                        else
                            plot(time_mouse_click(index6),0,'s','MarkerFaceColor','red','MarkerSize',8)
                            text(time_mouse_click(index6),0.05,'ESD','Rotation',90,'FontSize',6)
                        end
                        xlabel('Time in Seconds')
                        ylabel({'Slider';'Position'})
                        hold off
...
%                         xlabel('Time in Seconds')
                        ...
                        y = zeros(length(Index_time),1)+0.05;
                        text(time_tags_distillation,y,char(alarms_flow_distillation),'Rotation',90,'FontSize',6)
                        hold on
                        ...
                        for i = 1:length(Index_alarm(:,1))
                            if sum(strcmpi(alarm_name1{k,m}(i,1),'T104_low'))>=1
                                ...
                                alarm_Tlow = char(alarm_T(:,1));
                                y = zeros(length(index),1);
                                plot(time_Tlow,y+0.5,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,0.05,'T104','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'T105_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'T105','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'T106_low'))>=1
                                ...
                                plot(time_Tlow,y,'v','MarkerFaceColor','red','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'T106','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
                            ...
                            elseif sum(strcmpi(alarm_name1{k,m}(i,1),'T104_cleared'))>=1
                                ...
                                plot(time_Tlow,y,'s','MarkerFaceColor','green','MarkerSize',8)
                                if length(index)==1
                                    text(time_Tlow,y+0.05,'T104','Rotation',90,'FontSize',6)
                                else
                                    text(time_Tlow,y+0.05,alarm_Tlow,'Rotation',90,'FontSize',6)
                                end
